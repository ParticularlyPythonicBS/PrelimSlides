...
## Background: Traditional Optimal control strategies
There are two main approaches to general optimal control:

- Pontryagin's maximum principle: (BVP) in hamiltonian framework
  - Explicitly  
