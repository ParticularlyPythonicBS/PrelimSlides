...
<dl>
  ...
  <dt><a href="#background-neural-networks-and-optimization">Neural Networks and optimization</a><dt>
      <dd>▹ <a href="#background-differentiable-computing">Background</a></dd>
      <dd>▹ <a href="#metalearning-activation-functions">Metalearning Activation functions</a></dd>
  
  <dt><a href="#background-control-and-chaos">Control and Chaos</a><dt>
      <dd>▹ <a href="#background-hamilton-jacobi-bellmanhjb-equation">Background</a></dd>
      <dd>▹ <a href="#neural-network-control-of-chaos">Neural Network control of chaos</a></dd>

  <dt><a href="#background-dynamics-and-symmetries">Dynamics and symmetries</a><dt>
    <dd>▹ <a href="#background-group-theory-for-dynamical-systems">Background</a></dd>
    <dd>▹ <a href="#symmetries-of-controllers">Symmetries of controllers</a></dd>
...
![](assets/ChatGPT.webp){fig-alt="ChatGPT" fig-align="left" width="250"}

![](assets/Microsoft_365_Copilot_Icon.webp){fig-alt="CoPilot" fig-align="center" width="250"}

![](assets/netket.webp){fig-alt="NetKet" fig-align="right" width="250"}
...
![](assets/chaos_cm.webp){fig-alt="Model Predictive control" fig-align="center" width=50%}
    </td>
  </tr>
</table>
...
![](figures/BG1/autodiff.webp){fig-alt="autodifferentiation diagram" width=80% }
...
![](figures/BG1/NN.webp){fig-alt="Neural Network diagram" width=80%}
...
::: {#second-column}
![](figures/BG1/backprop_zoomed.webp){fig-alt="backprop diagram" fig-align="right" width=80%}
:::
::::
...
::: {#second-column}
![](figures/BG1/Metalearning.webp){fig-alt="metalearning" fig-align="center" width=80%}
:::
::::
...
<img src="figures/BG1/HNN.webp" alt="HNN schema" style="display: block; width: 30%; margin-top: -25px; margin-left: auto; margin-right: auto;">
...
::: {#second-column}
![](figures/Result1/meta_act_schema_vert.webp){fig-alt="metalearning" fig-align="center" width=80%}
:::
::::
...
::: {#second-column}
![](figures/Result1/2NeuronSubpopulation_Sine_1_compact2.webp){fig-alt="2neuronmnist1d" fig-align="center" width=100%}
:::
::::
...
![](figures/Result1/meta_div_scaling.webp){fig-alt="scaling" fig-align="center" width=80%}
...
![](figures/Result1/real_pendulum.webp){fig-alt="real world example" fig-align="center" width=80%}
...
![](figures/Result1/Participation_ratio.webp){fig-alt="participation ratio" fig-align="center" width=100%}
...
![](figures/Result1/Noisy_descent.webp){fig-alt="Noisy descent" fig-align="center" width=30%}
</div>
...
![](figures/Result1/learned_act_insight.webp){fig-alt="spanning sets" fig-align="center" width=80%}
...
For a control system with state $x(t)$ and control $u(t)$,
$$
...
![](figures/BG2/MPC_basic.webp){fig-alt="Model Predictive control" fig-align="center" width=100%}
    </td>
  </tr>
</table>
...
![](figures/BG2/OGY.webp){fig-alt="Ott-Gerbogi-Yorke control" fig-align="center" width=80%}

![](figures/BG2/UPO.webp){fig-alt="Unstable periodic orbits" fig-align="center" width=40%}
...
<video width="700" height="300" loop style="display: block; margin-left: auto; margin-right: auto;">
  <source src="figures/BG2/fireflies_vid.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
![](figures/Result2/MPC_NN.webp){fig-alt="Model Predictive control" fig-align="center" width=100%}
...
![](figures/Result2/kuramoto_control.webp){fig-alt="Controlled kuramoto dynamics" fig-align="center" width=100%}
...
![](figures/Result2/controlled_pendulum_dynamics.webp){fig-alt="Controlled Pendulum dynamics" fig-align="center" width=70%}
...
<video width="820" height="700" loop style="display: block; margin-left: auto; margin-right: auto;">
  <source src="figures/Result2/ks_combined_no_eq_alpha.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
</div>
...
![](figures/Result2/recurrence_matrix_lorenz.webp){fig-alt="Recurrence matrix for lorenz attractor" fig-align="center" width=70%}
...
Fixed pt subspace:
Let $\sigma \in \Sigma \subseteq \Gamma$. $\text{Fix}(\Sigma)=\{v \in \mathbb{R}^n:\sigma v=v\}$
...
<img src="figures/BG3/lift_project.webp" alt="Group equivariance works by lifting and projection" style="width: 50%;">
</div>
...
## Acknowledgements {background-image="assets/ks_pretty.webp" background-size="contain" background-position="center" background-repeat="no-repeat}

<div style="text-align: center; margin-top: 100px;">
<img src="assets/acknowledgements.webp" alt="Bill, John, Anshul" style="width: 400px;">
</div>
...
![](figures/Backup/MNIST1D.webp){fig-alt="MNIST1D" fig-align="center" width=70%}
...
![Roessler lyap](figures/Backup/roessler_det.webp){fig-alt="Roessler lyap" fig-align="center" width=100%}

![Roessler rec](figures/Backup/roessler_rec.webp){fig-alt="Roessler recurrence" fig-align="center" width=100%}
...
![Autoencoder](assets/Autoencoder_schema.webp){fig-alt="Autoencoder" fig-align="right" width=60%}


![GRU](assets/Gated_Recurrent_Unit_schema.webp){fig-alt="GRU" fig-align="left" width=100%}

:::

![CNN](assets/Typical_cnn.webp){fig-alt="CNN" fig-align="center" width=100%}
